...
if __name__ == "__main__":
    ...
    cdno["chebi_id"] = cdno["chebi_id"].replace(
        {
            "http://purl.obolibrary.org/obo/CHEBI_80096": "http://purl.obolibrary.org/obo/CHEBI_166888"
        }
    )
    ...
    for fdc_id in fdc_ids:
        ...
        cdno_fdc = cdno[
            cdno["fdc_nutrient_ids"].apply(lambda x, fdc_id=fdc_id: fdc_id in x)
        ]
        if len(cdno_fdc) == 1:
