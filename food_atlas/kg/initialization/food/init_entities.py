...
if __name__ == '__main__':
    ...
    entities['external_ids'] = entities['foodon_id'].apply(lambda x: {'foodon': [x]})
    map_foodon_to_faid = {}
    for i, row in entities.iterrows():
        map_foodon_to_faid[row['external_ids']['foodon'][0]] = row['foodatlas_id']
    ...
    entities['_synonyms_display'] = entities['synonyms']
